...
if __name__ == "__main__":
    ...
    data_root = "/media/cgy/disk2/BalanceFL/data/PathMnist"
    assert dataset in ["CIFAR100", "CIFAR10","PathMnist"]
    ...
    if not args.test:
        ...
        for round_i in range(config["fl_opt"]["rounds"]):
            ...
            if test_acc_mean > best_acc:
                ...
                # del ckpt
        expepriment_log_name = "experiment_log_PathMnist_seed7_trainIF0.02_fedavg.txt"
