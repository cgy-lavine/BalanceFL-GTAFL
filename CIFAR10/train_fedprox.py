...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--exp_name", default="fedprox_test2", type=str, help="exp name"
    )
    parser.add_argument(
    ...
    parser.add_argument("--lep", type=int, default=2, choices=[1, 2, 5])
    ...
    global_num_per_class = np.array(train_num_per_cls)
    """"
    FL config setup 
    """
    # assign devices
