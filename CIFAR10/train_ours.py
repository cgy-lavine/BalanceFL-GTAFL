...
Support different datasets/losses/samplings. s
"""
...
if __name__ == "__main__":
    ...
    # }
    data_root_dict = {
        # "TissueMnist": "../dataset/TissueMnist",
    ...
    parser.add_argument("--tao_ratio", type=float, default=4, choices=[1, 2, 4])
    ...
    print("client_per_round:{}".format(client_per_round))
    ...
    if not args.test:
        ...
        for round_i in range(config["fl_opt"]["rounds"]):
            ...
            # train and aggregate
            fed.local_train(selected_idx,round_i)#修改round_i
